...
export default function CreateModuleTags() {
                ...
                >
                    <div>
                        <h2 className="text-2xl font-semibold text-gray-800 w-full text-center">
                           What are the topics of your module?
                        </h2>
...
export const tagsActionModule = async ({ request, params }: ActionFunctionArgs) => {
    ...
    const response = await fetch(
        `http://localhost:3000/api/modules/tags/${params.moduleId}`,
        {
            method: "POST",
            headers: {
    ...
    return redirect(`/create-module-sections/${params.moduleId}`);
};
